...
const MobileDevelopmentPage: React.FC = () => {
  ...
  const features = [
    {
      icon: FaMobileAlt,
      title: t("mobileDevelopmentFeature1Title"),
      description: t("mobileDevelopmentFeature1Desc"),
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      icon: FaApple,
      title: t("mobileDevelopmentFeature2Title"),
      description: t("mobileDevelopmentFeature2Desc"),
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: FaAndroid,
      title: t("mobileDevelopmentFeature3Title"),
      description: t("mobileDevelopmentFeature3Desc"),
      gradient: "from-orange-500 to-red-500",
    },
    {
      icon: FaCode,
      title: t("mobileDevelopmentFeature4Title"),
      description: t("mobileDevelopmentFeature4Desc"),
      gradient: "from-green-500 to-emerald-500",
    },
    {
      icon: FaRocket,
      title: t("mobileDevelopmentFeature5Title"),
      description: t("mobileDevelopmentFeature5Desc"),
      gradient: "from-indigo-500 to-blue-500",
    },
    {
      icon: FaShieldAlt,
      title: t("mobileDevelopmentFeature6Title"),
      description: t("mobileDevelopmentFeature6Desc"),
      gradient: "from-yellow-500 to-orange-500",
    },
  ];

  const benefits = [
    t("mobileDevelopmentBenefit1"),
    t("mobileDevelopmentBenefit2"),
    t("mobileDevelopmentBenefit3"),
    t("mobileDevelopmentBenefit4"),
    t("mobileDevelopmentBenefit5"),
    t("mobileDevelopmentBenefit6"),
  ];
          ...
          <div className="container mx-auto">
            ...
            <div className="mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-white mb-12">
                {t("mobileDevelopmentServicesTitle")}
              </h2>
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-white mb-8">
                {t("mobileDevelopmentBenefitsTitle")}
              </h2>
