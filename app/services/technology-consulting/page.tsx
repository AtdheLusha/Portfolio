...
const TechnologyConsultingPage: React.FC = () => {
  ...
  const features = [
    {
      icon: FaLightbulb,
      title: t("technologyConsultingFeature1Title"),
      description: t("technologyConsultingFeature1Desc"),
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      icon: FaChartLine,
      title: t("technologyConsultingFeature2Title"),
      description: t("technologyConsultingFeature2Desc"),
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: FaCogs,
      title: t("technologyConsultingFeature3Title"),
      description: t("technologyConsultingFeature3Desc"),
      gradient: "from-orange-500 to-red-500",
    },
    {
      icon: FaShieldAlt,
      title: t("technologyConsultingFeature4Title"),
      description: t("technologyConsultingFeature4Desc"),
      gradient: "from-green-500 to-emerald-500",
    },
    {
      icon: FaRocket,
      title: t("technologyConsultingFeature5Title"),
      description: t("technologyConsultingFeature5Desc"),
      gradient: "from-indigo-500 to-blue-500",
    },
    {
      icon: FaHandshake,
      title: t("technologyConsultingFeature6Title"),
      description: t("technologyConsultingFeature6Desc"),
      gradient: "from-yellow-500 to-orange-500",
    },
  ];

  const benefits = [
    t("technologyConsultingBenefit1"),
    t("technologyConsultingBenefit2"),
    t("technologyConsultingBenefit3"),
    t("technologyConsultingBenefit4"),
    t("technologyConsultingBenefit5"),
    t("technologyConsultingBenefit6"),
  ];
          ...
          <div className="container mx-auto">
            ...
            >
              <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed text-center">
                {t("technologyConsultingMainDesc")}
              </p>
            </motion.div>
            ...
            <div className="mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-white mb-12">
                {t("technologyConsultingServicesTitle")}
              </h2>
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-white mb-8">
                {t("technologyConsultingBenefitsTitle")}
              </h2>
