...
const UIUXDesignPage: React.FC = () => {
  ...
  const features = [
    {
      icon: FaPalette,
      title: t("uiUxDesignFeature1Title"),
      description: t("uiUxDesignFeature1Desc"),
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      icon: FaUserCheck,
      title: t("uiUxDesignFeature2Title"),
      description: t("uiUxDesignFeature2Desc"),
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: FaMobileAlt,
      title: t("uiUxDesignFeature3Title"),
      description: t("uiUxDesignFeature3Desc"),
      gradient: "from-orange-500 to-red-500",
    },
    {
      icon: FaRocket,
      title: t("uiUxDesignFeature4Title"),
      description: t("uiUxDesignFeature4Desc"),
      gradient: "from-green-500 to-emerald-500",
    },
    {
      icon: FaEye,
      title: t("uiUxDesignFeature5Title"),
      description: t("uiUxDesignFeature5Desc"),
      gradient: "from-indigo-500 to-blue-500",
    },
    {
      icon: FaPaintBrush,
      title: t("uiUxDesignFeature6Title"),
      description: t("uiUxDesignFeature6Desc"),
      gradient: "from-yellow-500 to-orange-500",
    },
  ];

  const benefits = [
    t("uiUxDesignBenefit1"),
    t("uiUxDesignBenefit2"),
    t("uiUxDesignBenefit3"),
    t("uiUxDesignBenefit4"),
    t("uiUxDesignBenefit5"),
    t("uiUxDesignBenefit6"),
  ];
