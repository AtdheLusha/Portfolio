...
const WebDevelopmentPage: React.FC = () => {
  ...
  const features = [
    {
      icon: FaCode,
      title: t("webDevelopmentFeature1Title"),
      description: t("webDevelopmentFeature1Desc"),
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      icon: FaLaptopCode,
      title: t("webDevelopmentFeature2Title"),
      description: t("webDevelopmentFeature2Desc"),
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: FaRocket,
      title: t("webDevelopmentFeature3Title"),
      description: t("webDevelopmentFeature3Desc"),
      gradient: "from-orange-500 to-red-500",
    },
    {
      icon: FaMobileAlt,
      title: t("webDevelopmentFeature4Title"),
      description: t("webDevelopmentFeature4Desc"),
      gradient: "from-green-500 to-emerald-500",
    },
    {
      icon: FaShieldAlt,
      title: t("webDevelopmentFeature5Title"),
      description: t("webDevelopmentFeature5Desc"),
      gradient: "from-indigo-500 to-blue-500",
    },
    {
      icon: FaCog,
      title: t("webDevelopmentFeature6Title"),
      description: t("webDevelopmentFeature6Desc"),
      gradient: "from-yellow-500 to-orange-500",
    },
  ];

  const benefits = [
    t("webDevelopmentBenefit1"),
    t("webDevelopmentBenefit2"),
    t("webDevelopmentBenefit3"),
    t("webDevelopmentBenefit4"),
    t("webDevelopmentBenefit5"),
    t("webDevelopmentBenefit6"),
  ];
